...
export const pieces_regex: string = unite_regex(knight_regex, bishop_regex, rook_regex, queen_regex);
...
export const pawn_promotions_regex: string = `${files_regex}((x)${files_regex})?(1|8)(=)?${pieces_regex}`;
console.log(pawn_promotions_regex);
