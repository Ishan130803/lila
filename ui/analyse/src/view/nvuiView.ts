import { type VNode, type LooseVNodes, type VNodeChildren, bind, hl, noTrans, enter } from 'lib/view';
...
import { liveText, Notify } from 'lib/nvui/notify';
...
function playMove(input: string, ctrl: AnalyseCtrl, notify: Notify): void {
...
function boardEventsHook(
  ...
  if (true) {
    ...
    console.log('Game Mode', ctrl.data.game.variant.key);
    const $board = $(el);
